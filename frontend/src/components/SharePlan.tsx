  ...
  return (
    <div className="space-y-4">
      ...
      {shareCode && (
        <div className="flex items-center gap-2">
          <input
            readOnly
            value={shareUrl}
            className="flex-1 bg-[#0a0a0a] border border-[#2a2a2a] rounded-lg px-3 py-2 text-xs text-gray-400 focus:outline-none truncate"
          />
          <button
            onClick={handleCopy}
            className="p-2 bg-[#2a2a2a] hover:bg-[#3a3a3a] rounded-lg transition shrink-0"
            title="Copiar enlace"
          >
      ...
      <div className="flex gap-2">
        <button
          onClick={handleShare}
          className="flex-1 bg-[#2a2a2a] hover:bg-[#3a3a3a] py-2 rounded-lg text-sm text-gray-300 transition flex items-center justify-center gap-2"
        >
      ...
      {qrGrid && (
        <div className="flex flex-col items-center gap-2 pt-2">
          ...
          <p className="text-[10px] text-gray-500">Escanea para ver el plan</p>
        </div>
      )}
    </div>
  );
