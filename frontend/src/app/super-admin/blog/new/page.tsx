...
export default function BlogNewPage() {
  ...
  useEffect(() => {
    if (!metaTitle || metaTitle === slugify(title.slice(0, -1))) {
      setMetaTitle(title);
    }
  }, [title]);
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              ...
              <textarea
                ...
                rows={3}
                placeholder="Breve descripcion del articulo (se muestra en las tarjetas)..."
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    >
                      {metaDescription || excerpt || 'Descripcion del articulo que se mostrara en los resultados de busqueda...'}
                    </p>
                  </div>
                </div>
              </div>
